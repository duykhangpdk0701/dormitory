...
const UserProfileEditPage: NextPageWithLayout = () => {
  ...
  const {
    ...
    setValue,
    formState: { errors },
  } = useForm<IEditUserProfileParams>({
  ...
  const onSubmit: SubmitHandler<IEditUserProfileParams> = (data) => {
    console.log(data);
  };
...
UserProfileEditPage.getLayout = function getLayout(page: ReactElement) {
