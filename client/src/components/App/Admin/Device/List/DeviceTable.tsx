...
import { IDeviceParams } from "@/pages/admin/device";

interface IDeviceTableProps {
  className?: string;
  data?: IDevice[];
  control: Control<IDeviceParams, any>;
  handleSubmit: UseFormHandleSubmit<IDeviceParams>;
  onSubmit: SubmitHandler<IDeviceParams>;
  watch: UseFormWatch<IDeviceParams>;
  isLoading: boolean;
}
...
const DeviceTable: FC<IDeviceTableProps> = (props) => {
