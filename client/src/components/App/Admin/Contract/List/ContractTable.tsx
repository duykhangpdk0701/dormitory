...
import ContractTableItem from "./TableItem";
...
import { IContractParams } from "@/pages/admin/contract";

interface IContractTableProps {
  className?: string;
  data?: IContract[];
  control: Control<IContractParams, any>;
  handleSubmit: UseFormHandleSubmit<IContractParams>;
  onSubmit: SubmitHandler<IContractParams>;
  watch: UseFormWatch<IContractParams>;
  isLoading: boolean;
}

const ContractTable: FC<IContractTableProps> = (props) => {
