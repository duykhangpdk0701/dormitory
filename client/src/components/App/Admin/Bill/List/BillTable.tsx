...
import BillTableItem from "./TableItem";
...
import { IBillParams } from "@/pages/admin/bill";
import IBill from "@/interfaces/Bill";

interface IBillTableProps {
  className?: string;
  data?: IBill[];
  control: Control<IBillParams, any>;
  handleSubmit: UseFormHandleSubmit<IBillParams>;
  onSubmit: SubmitHandler<IBillParams>;
  watch: UseFormWatch<IBillParams>;
  isLoading: boolean;
}

const BillTable: FC<IBillTableProps> = (props) => {
